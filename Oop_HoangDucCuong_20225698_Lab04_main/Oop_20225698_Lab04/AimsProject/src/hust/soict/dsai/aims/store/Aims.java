...
public class Aims {
    ...
    public static void updateStoreMenu(Scanner scanner, Store store) {
        ...
        switch (option) {
            case 1 -> {
                ...
                System.out.print("Nguyen Trong Hinh - 20225842 - Enter id: ");
                int id = scanner.nextInt();
                scanner.nextLine();
                System.out.print("Nguyen Trong Hinh - 20225842 - Enter title: ");
                String title = scanner.nextLine();
                System.out.print("Nguyen Trong Hinh - 20225842 - Enter category: ");
                String category = scanner.nextLine();
                System.out.print("Nguyen Trong Hinh - 20225842 - Enter cost: ");
                float cost = scanner.nextFloat();
                scanner.nextLine();
                switch (option2) {
                    case 1 ->
                    {
                        System.out.print("Nguyen Trong Hinh - 20225842 - Enter director's name: ");
                        String director = scanner.nextLine();
                        System.out.print("Nguyen Trong Hinh - 20225842 - Enter dvd's length: ");
                        int length = scanner.nextInt();
                        scanner.nextLine();
                        store.addMedia(new DigitalVideoDisc(id,title,category,cost,director,length));
                    }
                    case 3 -> {
                        System.out.print("Nguyen Trong Hinh - 20225842 - Enter author's name (Enter nothing to skip): ");
                    ...
                    case 2 -> {
                        System.out.print("Nguyen Trong Hinh - 20225842 - Enter artist's name: ");
						String artist = scanner.nextLine();
                        System.out.print("Nguyen Trong Hinh - 20225842 - Enter number of track: ");
                        int nbTrack = scanner.nextInt();scanner.nextLine();
						ArrayList<Track> tracks = new ArrayList<>();
                        StringBuilder name = new StringBuilder();
                        for(int i = 0;i< nbTrack;i++) {
                            System.out.print("Nguyen Trong Hinh - 20225842 - Enter Track[" + i + "]'s name: ");
                            name.replace(0,name.length(),scanner.nextLine());
                            System.out.print("Nguyen Trong Hinh - 20225842 - Enter Track[" + i + "]'s length: ");
                            int length = scanner.nextInt();
            ...
            case 2 -> {
                System.out.println("Nguyen Trong Hinh - 20225842 - Enter item's title: ");
                scanner.nextLine();
                String title = scanner.nextLine();
            ...
            case 3 -> {
                System.out.println("Nguyen Trong Hinh - 20225842 - Enter item's id: ");
                int id = scanner.nextInt();
                scanner.nextLine();
                System.out.print("Nguyen Trong Hinh - 20225842 - Enter title: ");
                String title = scanner.nextLine();
    ...
    public static void mediaDetailsMenu(Scanner scanner, Store store, Cart cart) {
        System.out.print("Nguyen Trong Hinh - 20225842 - Enter media's title: ");
        String title = scanner.nextLine();
        Media item = store.findMedia(title);
        if(item == null) {
            System.out.println("Nguyen Trong Hinh - 20225842 - There is no such media !");
            return;
        }
            ...
            switch (option) {
                ...
                case 2 -> {
                    if (item.getClass().getSimpleName().equals("Book")) {
                        System.out.println("Nguyen Trong Hinh - 20225842 - This media is unplayable");
                    } else {
    ...
    public static void cartMenu(Scanner scanner,Cart cart) {
        while (true) {
            ...
            switch (option) {
                ...
                case  5 -> {
                    System.out.println("Nguyen Trong Hinh - 20225842 - Your cart have been paid\nThanks for using our service");
                    cart.emptyCart();
                }
            }
        }
